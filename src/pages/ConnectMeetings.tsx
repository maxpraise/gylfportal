    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Track and report your GYLF Connect meetings
          </p>
        </div>
      ...
      {showForm && (
        <Card className="border-primary/20">
          <CardHeader>
            ...
            <CardDescription>
              Submit your GYLF Connect meeting report
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your GYLF Connect meeting reports
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-4">
              {meetings.map((meeting) => (
                <div key={meeting.id} className="flex items-center gap-4 p-4 border rounded-lg hover:bg-muted/50 transition-colors">
